...
class Message extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
                            ...
                            children: [
                              if (longPressSelect && !event.redacted)
                                ...
                                Avatar(
                                  ...
                                  presenceUserId:
                                      event.senderFromMemoryOrFallback.stateKey,
    ...
    if (SwipeableChatLayoutTransition.maybeOf(context) != null) {
      return Center(child: messageContainer);
    }
